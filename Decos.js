...
class Decos extends Deco{
    ...
    InitDecoData(objPnjs){
        ...
        decos.push(this.CreateDeco("vase noir", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["noir"]));
        decos.push(this.CreateDeco("vase orange", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["orange"]));
        decos.push(this.CreateDeco("vase marron", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["marron"]));
        decos.push(this.CreateDeco("vase jaune", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["jaune"]));
        decos.push(this.CreateDeco("vase violet", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["violet"]));
        decos.push(this.CreateDeco("vase blanc", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["blanc"]));
        decos.push(this.CreateDeco("vase bleu", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["bleu"]));
        decos.push(this.CreateDeco("vase vert", objPnjs.getPnjById(5),"5 blocs d'émeraude","","oui",["vert"]));
        ...
        decos.push(this.CreateDeco("vase rose", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["rose"]));
        decos.push(this.CreateDeco("vase bleu foncé", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["bleu"]));
        decos.push(this.CreateDeco("vase jaune 2", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["jaune"]));
        decos.push(this.CreateDeco("vase cyan", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["bleu"]));
        decos.push(this.CreateDeco("vase violet foncé", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["violet"]));
        decos.push(this.CreateDeco("vase blanc jaune", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["blanc"]));
        decos.push(this.CreateDeco("vase rouge", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["rouge"]));
        decos.push(this.CreateDeco("vase gris", objPnjs.getPnjById(7),"5 blocs d'émeraude","","oui",["gris"]));
